...
namespace G3D {
	...
	*/
	...
	public:
		...
		AABox           bounds = AABox(Point3(0.0f, 0.0f, 0.0f), Point3(1.0f, 1.0f, 1.0f));
		...
		*/
		...
		DDGIVolumeSpecification(const Any& any) {
			*this = DDGIVolumeSpecification(any, AABox(Vector3(-1, -1, -1), Vector3(1, 1, 1)), AABox(Vector3(-1, -1, -1), Vector3(1, 1, 1)));
		}
	};
